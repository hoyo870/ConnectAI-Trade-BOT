...
| SOL | **+779%** | 28.9% | 7.20 | 2.8% | 8.423 | **+436%** |
| XRP | **+358%** | 28.6% | 7.52 | 3.4% | 7.027 | **+251%** |
...
| SOL | **10/10** | 10/10 | **+1572%** | +219% |
| XRP | **10/10** | 10/10 | **+4213%** | +235% |

> XRP hist 평균이 큰 이유: 2020-11~2021-03 역사적 랠리 구간 포함 (+38,669%)  
> 해당 구간 제외 시 XRP 평균 약 +370%/3개월 (여전히 강력)
