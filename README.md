...
> 엔진: `backtest_af_exact.py` + AFEnsemble (theta=0.300) — live_trader 완벽 모방

| 코인 | 수익률 | TPD | MDD | WR | PF | Top-5 제거 | 판정 |
|------|-------|-----|-----|-----|-----|-----------|------|
| BTC  | +129.4% | 2.33 ✅ | 16.8% | 26.6% | 1.647 | +22.6% ✅ | 3/3 ✅ |
| ETH  | +91.3%  | 3.55 ✅ | 26.5% | 24.6% | 1.300 | -1.7% ❌  | 2/3 ⚠️ |
| SOL  | +305.3% | 3.83 ✅ | 25.5% | 24.7% | 1.596 | +64.0% ✅ | 3/3 ✅ |
| XRP  | +113.2% | 3.29 ✅ | 32.4% | 24.1% | 1.365 | +12.1% ✅ | 3/3 ✅ |
